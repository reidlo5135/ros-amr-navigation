...
static uint64_t amr_mqtt_robot_plugin_now_ms(void)
{
...
static void amr_mqtt_robot_plugin_set_default_config(void)
{
  ...
  amr_mqtt_robot_plugin_copy_string(
    g_amr_mqtt_robot_plugin_config.mqtt.telemetry_robot_description,
    sizeof(g_amr_mqtt_robot_plugin_config.mqtt.telemetry_robot_description),
  ...
  amr_mqtt_robot_plugin_copy_string(
    ...
    "/joint_states");
  amr_mqtt_robot_plugin_copy_string(
    g_amr_mqtt_robot_plugin_config.ros.topic_robot_description,
    sizeof(g_amr_mqtt_robot_plugin_config.ros.topic_robot_description),
    "/robot_description");
  amr_mqtt_robot_plugin_copy_string(
...
static void amr_mqtt_robot_plugin_load_parameter_overrides(void)
{
  ...
  if (node_params != NULL) {
    ...
    amr_mqtt_robot_plugin_read_string_param(node_params, "mqtt.topics.telemetry.robot_description", g_amr_mqtt_robot_plugin_config.mqtt.telemetry_robot_description, sizeof(g_amr_mqtt_robot_plugin_config.mqtt.telemetry_robot_description));
    ...
    amr_mqtt_robot_plugin_read_string_param(node_params, "ros.topics.robot_description", g_amr_mqtt_robot_plugin_config.ros.topic_robot_description, sizeof(g_amr_mqtt_robot_plugin_config.ros.topic_robot_description));
...
static void amr_mqtt_robot_plugin_telemetry_callback(const void * message, void * context)
{
  amr_mqtt_robot_plugin_telemetry_endpoint_t * endpoint =
    (amr_mqtt_robot_plugin_telemetry_endpoint_t *)context;
  char * payload = NULL;
  char viz_topic[AMR_MQTT_ROBOT_PLUGIN_MAX_STRING_LENGTH] = {0};
  rmw_serialized_message_t serialized_message = rmw_get_zero_initialized_serialized_message();
  const uint64_t now_ms = amr_mqtt_robot_plugin_now_ms();
...
static int amr_mqtt_robot_plugin_init_ros_interfaces(void)
{
  ...
  if (!nav_msgs__msg__OccupancyGrid__init(&g_amr_mqtt_robot_plugin_ros_state.map_message) ||
    ...
    !std_msgs__msg__String__init(&g_amr_mqtt_robot_plugin_ros_state.robot_description_message) ||
  ...
  g_amr_mqtt_robot_plugin_ros_state.robot_description_subscription = rcl_get_zero_initialized_subscription();
  ...
  amr_mqtt_robot_plugin_configure_endpoint(
    ...
    0U);
  amr_mqtt_robot_plugin_configure_endpoint(
    &g_amr_mqtt_robot_plugin_ros_state.telemetry_endpoints[14],
    "robot_description",
    g_amr_mqtt_robot_plugin_config.ros.topic_robot_description,
    g_amr_mqtt_robot_plugin_config.mqtt.telemetry_robot_description,
    &g_amr_mqtt_robot_plugin_ros_state.robot_description_subscription,
    &g_amr_mqtt_robot_plugin_ros_state.robot_description_message,
...
static void amr_mqtt_robot_plugin_fini_ros_interfaces(void)
{
  ...
  if (g_amr_mqtt_robot_plugin_ros_state.messages_initialized) {
    ...
    std_msgs__msg__String__fini(&g_amr_mqtt_robot_plugin_ros_state.robot_description_message);
