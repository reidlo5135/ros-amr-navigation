...
/AMR_LOG/ {
  ...
  fields[53] = value_of(entry, "previous_idx")
  fields[54] = value_of(entry, "rejoin_activated")
  fields[55] = value_of(entry, "result")
  fields[56] = value_of(entry, "recovery_type")
  fields[57] = value_of(entry, "planner_ok")
  fields[58] = value_of(entry, "controller_ok")
  fields[59] = value_of(entry, "local_plan_valid")
  fields[60] = value_of(entry, "planner_decision")
  fields[61] = value_of(entry, "odom_delta_m")
  fields[62] = value_of(entry, "odom_delta_yaw_rad")
  fields[63] = value_of(entry, "pose_delta_m")
  fields[64] = value_of(entry, "pose_delta_yaw_rad")
  fields[65] = value_of(entry, "applied_delta_m")
  fields[66] = value_of(entry, "applied_delta_yaw_rad")
  fields[67] = value_of(entry, "slip_suspected")
  fields[68] = value_of(entry, "stall_suspected")
  fields[69] = value_of(entry, "confirmed")
  fields[70] = value_of(entry, "correction_limited")
  fields[71] = value_of(entry, "correction_delta_m")
  fields[72] = value_of(entry, "correction_delta_yaw_rad")
  fields[73] = value_of(entry, "start_row")
  fields[74] = value_of(entry, "goal_row")
  fields[75] = value_of(entry, "row_delta")
  fields[76] = value_of(entry, "same_row_candidate")
  fields[77] = value_of(entry, "straight_line_safe")
  fields[78] = value_of(entry, "straight_path_used")
  fields[79] = value_of(entry, "fallback_reason")
  fields[80] = value_of(entry, "final_path_points")
  fields[81] = value_of(entry, "max_row_deviation")
  fields[82] = value_of(entry, "max_lateral_deviation_m")
  fields[83] = value_of(entry, "current_yaw_rad")
  fields[84] = value_of(entry, "target_yaw_rad")
  fields[85] = value_of(entry, "tracking_reset")
